...
/// </remarks>
public class OurTownMessenger : MonoBehaviour, IChatClientListener
{
    string[] ChannelsToJoinOnConnect = { "OurTown" }; // set in inspector. Demo channels to join automatically.
    int HistoryLengthToFetch = 0; // set in inspector. Up to a certain degree, previously sent messages can be fetched for context
    ...
    private static string WelcomeText = "Go";
