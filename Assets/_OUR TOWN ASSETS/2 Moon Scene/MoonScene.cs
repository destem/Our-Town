...
public class MoonScene : MonoBehaviour {
    ...
    IEnumerator RunMoonScene()
    {
        print("Starting Moon scene");
        yield return new WaitForSeconds(1f); //gesture not getting initialized fast enough??
        print("Waiting to activate The More You Know gesture to start houses");
        while (!next)
        {
            yield return null;
        }
        ...
        print("Waiting to activate double fancy gesture to start stars");
        while (!next)
        {
            yield return null;
        }
        ...
        print("Waiting to activate shrug gesture to start outer details and words");
        while (!next)
        {
            yield return null;
        }
        ...
        print("Waiting to activate lean left gesture to start inner details");
        while (!next)
        {
            yield return null;
        }
        ...
        print("Waiting to activate step and sweep gesture to start moon growth");
        while (!next)
        {
            yield return null;
        }
        ...
        yield return null;
        print("Waiting to activate backswing gesture to start blackouts");
        while (!next)
        {
            yield return null;
        }
        ...
        print("Waiting to activate lean left gesture to start final windows");
        while (!next)
        {
            yield return null;
        }
        ...
        print("Waiting to activate The More You Know gesture to fade out");
        while (!next)
        {
            yield return null;
        }
