...
public class OurTownManagerExperimental : MonoBehaviour, IChatClientListener
{
    ...
    public GameObject moonScene;
    public GameObject rainScene;
    public GameObject treeScene;
    public GameObject mistScene;
    ...
    void DisableAll()
    {
        ...
        moonScene.SetActive(false);
        rainScene.SetActive(false);
        treeScene.SetActive(false);
        mistScene.SetActive(false);
        oceanScene.SetActive(false);
    ...
    {
        treeScene.SetActive(true);
    }

    public void GotoMist()
    {
        mistScene.SetActive(true);
    }

    public void GotoOcean()
    {
        oceanScene.SetActive(true);
    }
